            ...
            <form method="GET" class="col s12">
              <div class="input-field col s12">
                <h4 style="color: #cbd0f7">
                  <div style="cursor:pointer" type="button" onclick="JavaScript:location.href='lstVendedor.php'"><img class="img_icon" src="img/vendedor.png" height="100px" width="100px"></div>
                  Vendedores
